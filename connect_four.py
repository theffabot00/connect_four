...
board = [[ token(" ", "neg") for x in range(0,7)] for y in range(0,6)]
import random
    ...
    if current_turn == 1:
        ...
        for x in range(0,7):   
            if board[1][x].tm == " ": 
                ...
                filler_tokens.append(token(" ",x-1))
                win_values[x] = -99
                risk_values[x] = -99
